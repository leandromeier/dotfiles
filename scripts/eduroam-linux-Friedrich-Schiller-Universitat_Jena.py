#!/usr/bin/env python3
"""
    Login credentials: <user-id(7 digits, numbers and letters)>@uni-jena.de
 * **************************************************************************
...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Friedrich-Schiller-Universität Jena"
Config.profilename = "eduroam"
Config.url = "https://www.uni-jena.de/itservice.html"
Config.email = "itservice@uni-jena.de"
Config.title = "eduroam CAT"
Config.server_match = "radius.netz.uni-jena.de"
...
Config.user_realm = "uni-jena.de"
Config.ssids = ['eduroam']
Config.del_ssids = ['guests.uni-jena.de']
Config.servers = ['DNS:radius.netz.uni-jena.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "geteduroam@uni-jena.de"
